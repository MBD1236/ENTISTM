...
class CreateReinscription extends Component
{
    use WithFileUploads;
    ...
    public function store()
    {
       ...
       que le numrecu existe */
        ...
        if (!is_string($this->photo)) {
                ...
                $this->reset();
                session()->flash('success', 'Reinscription effectuée avec succès!');
    }
    
    #[Layout("components.layouts.template-etudiant")]
    public function render()
    {
        return view('livewire.etudiant.create-reinscription',[
