...
class ImpInformationsEdit extends Component
{
    use WithFileUploads;
    /**
    ...
    */
    ...
    public function update()
    {
        ...
        $this->reset();
        return redirect()->route('imp.information.list')->with('success', 'Information modifiée avec succès!');
    }
    ...
    {
        return view('livewire.departements.i-m-p.imp-informations-edit');
    }
}
