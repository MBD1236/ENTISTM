...
class InformationDepartementEdit extends Component
{
    use WithFileUploads;
    /**
    ...
    */
    ...
    public function update()
    {
        ...
        $this->reset();
        return redirect()->route('genieinfo.information.list')->with('success', 'Information modifiée avec succès!');
    }
    ...
    {
        return view('livewire.departements.genie-informatique.information-departement-edit');
    }
}
