...
class TlEnseignantsEdit extends Component
{
    use WithFileUploads;
    /**
     * @var Enseignant
    ...
    */
    ...
    {
        return view('livewire.departements.t-l.tl-enseignants-edit',[
            'departements' => Departement::were('departement', 'Techniques de laboratoires')->get()
        ]);
    }
}
