...
class TlInformationsCreate extends Component
{
    use WithFileUploads;
    ...
    public function store()
    {
        ...
        if ($existe) {
            return redirect()->route('tl.information.list')->with('error', 'Un département avec ces informations existe déjà. Vous ne pouvez pas en créer un autre. Vous pouvez cliquer sur le bouton modifier en bas pour modifier les infomations');
        }
        ...
        $this->reset();
        return redirect()->route('tl.information.list')->with('success', 'Département enregistré avec succès!');
    }
    ...
    {
        return view('livewire.departements.t-l.tl-informations-create',[
