...
class TlEnseignantsCreate extends Component
{
    use WithFileUploads;
    ...
    */
    ...
    public function cancel() {
        $this->clearStatus();
        return to_route('tl.enseignants');
    }
    ...
    */
    public function store()
    {
        ...
        if ($verify_enseignant === 0) {
            ...
            $this->reset();
            return redirect()->route('tl.enseignants')->with('success', 'Enseignant enregistré avec succès!');
        }
    ...
    public function render()
    {
        ...
        return view('livewire.departements.t-l.tl-enseignants-create',[
            'departements' => Departement::where('departement', 'Techniques de laboratoires')->get()
        ]);
    }
}
