...
class TlEtudiantsTables extends Component
{
    ...
    public function render()
    {
         ...
         $etudiant->where('programme', "Techniques de Laboratoire Biologie");
         $etudiant->where('programme', "Techniques de Laboratoire Chimie");
        ...
        return view('livewire.departements.t-l.tl-etudiants-tables',[
            'etudiants' => $etudiants,
            'niveaux' => Niveau::all(),
