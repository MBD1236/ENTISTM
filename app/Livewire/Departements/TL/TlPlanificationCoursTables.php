...
class TlPlanificationCoursTables extends Component
{
    public $semestre = 0;
    ...
    public function render()
    {
        ...
        $matieres = Matiere::query()->whereHas('programme', function ($query) {
                    $query->where('programme', 'Technique de Laboratoire Biologie');
                    $query->orWhere('programme', 'Technique de Laboratoire Chimie');
                })->get();
           
        return view('livewire.departements.t-l.tl-planification-cours-tables',[
            ...
            'niveaux' => Niveau::all(),
            'programmes' => Programme::where('programme', 'Technique de Laboratoire Biologie')
                    ->orWhere('programme', 'Technique de Laboratoire Chimie')->get()
        ]);
    }
}
