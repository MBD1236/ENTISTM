...
class TebInformationsCreate extends Component
{
    use WithFileUploads;
    ...
    public function cancel() {
        $this->clearStatus();
        return to_route('teb.information.list');
    }
    ...
    public function store()
    {
        ...
        if ($existe) {
            return redirect()->route('teb.information.list')->with('error', 'Un département avec ces informations existe déjà. Vous ne pouvez pas en créer un autre. Vous pouvez cliquer sur le bouton modifier en bas pour modifier les infomations');
        }
        ...
        $this->reset();
        return redirect()->route('teb.information.list')->with('success', 'Département enregistré avec succès!');
    }
    ...
    {
        return view('livewire.departements.t-e-b.teb-informations-create',[
