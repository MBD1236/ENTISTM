...
class TebEnseignantsCreate extends Component
{
    use WithFileUploads;
    ...
    */
    public function store()
    {
        ...
        if ($verify_enseignant === 0) {
            ...
            $this->reset();
            return redirect()->route('teb.enseignants')->with('success', 'Enseignant enregistré avec succès!');
        }
    ...
    {
        return view('livewire.departements.t-e-b.teb-enseignants-create',[
            'departements' => Departement::where('departement', 'Technologies des Equipements Biomédicaux')->get()
        ]);
    }
}
