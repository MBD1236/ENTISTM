...
class TebInformationsEdit extends Component
{
    use WithFileUploads;
    /**
    ...
    */
    ...
    public function update()
    {
        ...
        $this->reset();
        return redirect()->route('teb.information.list')->with('success', 'Information modifiée avec succès!');
    }
    ...
    {
        return view('livewire.departements.t-e-b.teb-informations-edit');
    }
}
