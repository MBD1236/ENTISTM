...
class TebPlanificationCoursTables extends Component
{
    public $semestre = 0;
    ...
    public function render()
    {
        ...
        return view('livewire.departements.t-e-b.teb-planification-cours-tables',[
            ...
            'enseignants' => Enseignant::whereHas('departement', function($d){
                $d->where('departement', 'Technologies des Equipements Biomédicaux');
            })->get(),
            'promotions' => Promotion::all(),
            'semestres' => Semestre::all(),
            'niveaux' => Niveau::all(),
            'programmes' => Programme::where('programme', 'Technologie des Equipements Biomédicaux')->get()
