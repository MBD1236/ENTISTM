...
class CfmEtudiantsTables extends Component
{
    use WithPagination;
    ...
    public function render()
    {
         ...
         $etudiant->where('programme', "Conception et Fabrication Mécanique");
        ...
        return view('livewire.departements.c-f-m.cfm-etudiants-tables',[
            'etudiants' => $etudiants,
            'niveaux' => Niveau::all(),
