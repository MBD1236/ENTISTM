...
class CfmInformationsEdit extends Component
{
    use WithFileUploads;
    /**
    ...
    */
    ...
    public function update()
    {
        ...
        $this->reset();
        return redirect()->route('cfm.information.list')->with('success', 'Information modifiée avec succès!');
    }
    ...
    {
        return view('livewire.departements.c-f-m.cfm-informations-edit');
    }
}
