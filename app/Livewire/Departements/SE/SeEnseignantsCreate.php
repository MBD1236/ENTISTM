...
class SeEnseignantsCreate extends Component
{
    use WithFileUploads;
    ...
    */
    public function store()
    {
        ...
        if ($verify_enseignant === 0) {
            ...
            $this->reset();
            return redirect()->route('scienceenergie.enseignant.list')->with('success', 'Enseignant enregistré avec succès!');
        }
    ...
    {
        return view('livewire.departements.s-e.se-enseignants-create',[
