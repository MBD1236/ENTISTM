...
class SeInscriptionsTables extends Component
{
    ...
    public function render()
    {
        ...
        return view('livewire.departements.s-e.se-inscriptions-tables',[
            'inscriptions' => $inscriptions,
            'niveaux' => Niveau::all(),
            'programmes' => Programme::where('departement_id', 2)->get()
        ]);
    }
}
