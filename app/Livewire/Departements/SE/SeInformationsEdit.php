...
class SeInformationsEdit extends Component
{
    use WithFileUploads;
    /**
    ...
    */
    public function cancel() {
        $this->clearStatus();
        return to_route('scienceenergie.information.list');
    }
    ...
    public function update()
    {
        ...
        $this->reset();
        return redirect()->route('scienceenergie.information.list')->with('success', 'Information modifiée avec succès!');
    }
    ...
    {
        return view('livewire.departements.s-e.se-informations-edit');
    }
}
