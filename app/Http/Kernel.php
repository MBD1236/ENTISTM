...
class Kernel extends HttpKernel
{
    ...
    protected $middlewareAliases = [
        ...
        'cfm' => \App\Http\Middleware\CfmMiddleware::class,
        't_laboratoire' => \App\Http\Middleware\TLaboratoireMiddleware::class,
        's_energie' => \App\Http\Middleware\SEnergieMiddleware::class,
        'etudiant' => \App\Http\Middleware\EtudiantMiddleware::class,
        'enseignant' => \App\Http\Middleware\EnseignantMiddleware::class,
        'comptabilite' => \App\Http\Middleware\ComptabiliteMiddleware::class,
