...
@section('content')
    <div class="card">
        <div class="card-header card-head">
            <h1 class="bg-card text-center text-white card-head"><i class="fa fa-send me-1"></i>Publier un Article</h1>
        </div>
        <div class="card-body">
            <div class="row">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-floating mb-3">
                            <input class="form-control border-input" value="{{ old('titre') }}" type="text" name="titre" id="floatingtitre" placeholder="Titre">
                        ...
                        <div class="tab-content pt-2" id="borderedTabJustifiedContent">
                            ...
                            <div class="tab-pane fade" id="bordered-justified-profile" role="tabpanel" aria-labelledby="profile-tab">
                                <div class="mt-2">
                                    <center><video controls class="img-photo card-photo" id="videoPreview"></video></center>
                        ...
                        <div class="row mt-3">
                            <div class="col">
                                <center><button type="submit" class="btn-modal"><i class="fa fa-send me-1"></i>Publier l'article</button></center>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-floating mb-3">
                            <input class="form-control border-input" value="{{ old('description') }}" type="text" name="description" id="floatingdescription" placeholder="Description">
                        ...
                        <div class="form-floating mb-3">
                            <textarea class="form-control border-input" value="{{ old('texte') }}" name="texte" id="floatingdetails" placeholder="Saisissez votre texte ici" style="height: 400px;"></textarea>
