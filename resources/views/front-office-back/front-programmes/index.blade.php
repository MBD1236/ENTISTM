    ...
    <div class="card">
        <div class="card-header card-head">
            <h1 class="bg-card text-center text-white card-head">
                <i class="fa fa-send me-1"></i>Publier un programme sur le fil de l'actualité
            </h1>
        </div>
        <div class="card-body">
            <div class="row">
                ...
                <div class="col-md-6">
                    ...
                    @if(session()->has('warning'))
                        <div class="alert alert-warning bg-warning text-dark border-0 alert-dismissible fade show" role="alert">
                            <h5 class="text-center">{{ session('warning') }}</h5>
                            <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
                            <i class="fa fa-exclamation-triangle icon-deleted text-dark"></i>
                        </div>
                    @endif
                </div>
                <div class="col-md-3"></div>
            </div>
            <form action="{{ route('frontprogramme.store') }}" method="POST" enctype="multipart/form-data" id="programmeForm">
                @csrf
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-floating mb-3">
                            <input class="form-control border-input" value="{{ old('intitule_programme') }}" type="text" name="intitule_programme" id="floatingintitule_programme" placeholder="Intitulé du programme" required>
                        ...
                        <div class="form-floating mb-3">
                            <input class="form-control border-input" value="{{ old('duree') }}" type="text" name="duree" id="floatingduree" placeholder="Durée du programme" required>
                        ...
                        <center>
                            <img id="imgPreview" class="img-photo card-photo" src="{{ asset('assets/img/téléchargement.png') }}" alt="Emplacement de l'image">
                        </center>
                    ...
                    <div class="col-md-6">
                        <div class="form-floating mb-3">
                            <select class="form-select border-input" name="type_programme" id="type_programme" required>
                                ...
                                <option value="Licence" {{ old('type_programme') == 'Licence' ? 'selected' : '' }}>Licence</option>
                                <option value="Master" {{ old('type_programme') == 'Master' ? 'selected' : '' }}>Master</option>
                            </select>
                        ...
                        <div class="form-floating mb-3">
                            <textarea class="form-control border-input" name="description" id="floatingdescription" placeholder="Saisissez la description du programme ici" style="height: 400px;" required>{{ old('description') }}</textarea>
