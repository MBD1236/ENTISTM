...
@section('content')
    <div class="card">
        <div class="card-header card-head">
            <h1 class="bg-card text-center text-white card-head"><i class="fa fa-edit me-1"></i>Modifier un témoignage</h1>
        </div>
        <div class="card-body">
            <div class="row">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-floating mb-3">
                            <input class="form-control border-input" value="{{ $temoignage->nom }}" type="text" name="nom" id="floatingnom" placeholder="nom">
                        ...
                        <div class="mt-2">
                            <div class="mt-2">
                                <div class="form-floating mb-3">
                                    <input class="form-control border-input" value="{{ $temoignage->fonction }}" type="text" name="fonction" id="floatingfonction" placeholder="Fonction">
                                    <label for="floatingfonction" class="label-control label-text">Fonction<span class="text-danger">*</span></label>
                                    @error('fonction')
                                        <p class="text-danger">{{ $message }}</p>
                                    @enderror
                                </div>
                                <center><img id="imgPreview" class="img-photo card-photo" src="{{ $temoignage->image_path && str_contains($temoignage->image_path, 'image') ? asset('storage/' . $temoignage->image_path) : asset('assets/img/téléchargement.png') }}" alt="Emplacement de l'image"></center>
                    ...
                    <div class="col-md-6">
                        <div class="form-floating mb-3">
                            <input class="form-control border-input" value="{{ $temoignage->prenom }}" type="text" name="prenom" id="floatingprenom" placeholder="Prénom">
                        ...
                        <div class="form-floating mb-3">
                            <textarea class="form-control border-input" name="texte" id="floatingtexte" placeholder="Saisissez votre texte ici" style="height: 400px;">{{ $temoignage->texte }}</textarea>
