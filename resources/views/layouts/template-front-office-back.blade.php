...
<body>
  ...
  <header id="header" class="header fixed-top d-flex align-items-center">
    ...
    <div class="d-flex align-items-center justify-content-between">
      <a href="{{ route('front.admin') }}" class="logo d-flex align-items-center">
    ...
    <aside id="sidebar" class="sidebar">
      ...
      <ul class="sidebar-nav" id="sidebar-nav">
        ...
        <li class="nav-item">
          <a class="nav-link" href="{{ route('front.admin') }}">
            ...
            <ul id="components-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
              <li>
                  <a href="{{ route('scolarite.orientation') }}">
                    <i class="fa fa-users"></i><span>Vie étudiant</span>
                  </a>
              </li>
            </ul>
        ...
        <li class="nav-item">
            <a class="nav-link collapsed" data-bs-target="#components-nav2" data-bs-toggle="collapse" href="#">
              <i class="fa fa-book"></i><span>Articles</span><i class="bi bi-chevron-down ms-auto"></i>
            </a>
            <ul id="components-nav2" class="nav-content collapse " data-bs-parent="#sidebar-nav">
              <li>
                  <a href="{{ route('articles.index') }}">
                    <i class="fa fa-plus"></i><span>Publier un article</span>
                  </a>
              </li>
              <li>
                  <a href="{{ route('articles.show') }}">
                    <i class="fa fa-book"></i><span>Les articles publiés</span>
                  </a>
              </li>
            </ul>
          </li><!-- End Components Nav -->
