            ...
            <div class="row">
                <div class="col-md-6">
                    ...
                    <form action="{{ route('departement.update', $departement->id) }}" method="POST">
                        ...
                        <div class="row">
                            <div class="col">
                                <label for="departement" class="label-control label-text">Modification du département :</label>
                                <input type="text" class="form-control border-input" name="departement" id="departement" value="{{ old('departement', $departement->departement) }}">
                                @error('departement')
                    ...
                    <table class="table table-bordered">
                        <thead>
                            <tr>
                                ...
                                <th class="text-center bg-light">Départements</th>
                            </tr>
                        </thead>
                        <tbody>
