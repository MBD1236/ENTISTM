                        ...
                        <div class="row mt-3">
                            <div class="col-md-11 m-auto">
                                <div class="row">
                                    <div class="col-md-6 my-2">
                                        <div class="form-floating">
                                            <input class="form-control border-input @error('reference_id') is-invalid @enderror" type="text" id="reference_id" name="reference_id" placeholder="reference_id" value="{{ old('reference_id', $numero) }}" readonly>
                                ...
                                <div class="row">
                                    <div class="col-md-6 my-2">
                                        <div class="form-floating">
                                            <input class="form-control border-input @error('prenom') is-invalid @enderror" type="text" id="floatingprenom" name="prenom" placeholder="Prénom" value="{{ old('prenom', $etudiant->prenom) }}">
                                    ...
                                    <div class="col-md-6 my-2">
                                        <div class="form-floating">
                                            <input class="form-control border-input @error('nom') is-invalid @enderror" type="text" id="floatingnom" name="nom" placeholder="Nom" value="{{ old('nom', $etudiant->nom) }}">
                                ...
                                <div class="row">
                                    <div class="col-md-6 my-2">
                                        <div class="form-floating">
                                            <input class="form-control border-input @error('telephone') is-invalid @enderror" type="text" id="floatingtelephone" name="telephone" placeholder="Téléphone" value="{{ old('telephone', $etudiant->telephone) }}">
                                    ...
                                    <div class="col-md-6 my-2">
                                        <div class="form-floating">
                                            <input class="form-control border-input @error('programme') is-invalid @enderror" type="text" id="floatingprogramme" name="programme" placeholder="Programme" value="{{ old('programme', $etudiant->programme) }}">
                                ...
                                <div class="row">
                                    <div class="col-md-10 py-2">
                                        <div class="d-flex flex-row justify-content-center gap-3">
                                            <div>
                                                <button type="submit" class="btn-modal py-3 px-5"><i class="fa fa-check me-2"></i>Enregistrer le réléve de note</button>
                                            </div>
                                            <div>
                                                <button type="button" onclick="window.history.back()" class="btn btn-danger py-3 px-5"><i class="fa fa-times me-2"></i>Annuler l'enregistrement</button>
                                            </div>
                                        </div>
                                    </div>
                                </div>
