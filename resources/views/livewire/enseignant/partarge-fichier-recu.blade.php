                ...
                <table class="table table-bordered table-hover">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="text-end">
                                <a title="Visualiser le fichier" class="fs-3 me-2" href="{{ Storage::url('public/partagefiles/' . $partage->fichier) }}" target="_blank"><i class="fa fa-eye btn-color-primary"></i></a>
                            </td>                            
                        </tr>
                        @empty
                            <tr>
