<div>
    ...
    <div class="card-header card-head">
        <h1 class="bg-card text-center text-white card-head"><i class="fa fa-book me-1"></i>La liste des niveaux</h1>
    </div>
    <div class="card">
        <div class="card-header">
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <form action="" enctype="multipart/form-data">
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <label for="type" class="label-control label-text">Niveau<span class="text-danger">*</span></label>
                                            <input type="text" id="niveau"  class="form-control border-input @error('niveau') is-invalid @enderror" placeholder="Niveau" wire:model='niveau' wire:click='resetError'>
                ...
                <div class="modal fade" id="modifDepartements" tabindex="-1" wire:ignore.self>
                    <div class="modal-dialog modal-sm">
                        <div class="modal-content">
                            <div class="modal-header bg-card-modal">
                                <h3 class="modal-title">Modification d'un niveau</h3>
                                <button type="button" class="bg-btn-close-modal" data-bs-dismiss="modal" aria-label="Close"><i class="fa fa-times"></i></button>
                            </div>
                            <div class="modal-body">
                                <form action="" enctype="multipart/form-data">
        ...
        <div class="card-body">
            <div class="row table-responsive">
                <table class="table table-bordered table-hover">
                    ...
                    <tbody>
                        @forelse ( $niveauxx as $k => $niv)
                        <tr>
                            <th>{{ $k+1 }}</th>
                            <td>{{ $niv->niveau }}</td>
                            <td class="">
                                <a type="button" title="Modifier" class="fs-5 me-1" wire:click='edit({{ $niv }})' data-bs-toggle="modal" data-bs-target="#modifDepartements"><i class="fa fa-edit btn-color-primary"></i></a>                               
                                <a class="me-1" href="" title="Supprimer" wire:click='delete({{ $niv }})' wire:confirm="Est ce que vous voulez supprimé cet niveau ?"><i class="fs-5 fa fa-trash text-danger"></i></a>
                            </td>
                        </tr>
                        @empty
                        <tr>
            ...
            <div class="row">
                <div class="col-sm-12 col-md-12">
                    <ul class="pagination-rounded">
                        {{$niveauxx->links('vendor.livewire.bootstrap')}}
                    </ul>
                </div>
            </div>
        </div>
