<div>
    ...
    <div class="card-header card-head">
        <h1 class="bg-card text-center text-white card-head"><i class="fa fa-book me-1"></i>La liste des semestres</h1>
    </div>
    <div class="card">
        <div class="card-header">
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <form action="" enctype="multipart/form-data">
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <label for="type" class="label-control label-text">Semestre<span class="text-danger">*</span></label>
                                            <input type="text" id="semestre"  class="form-control border-input @error('semestre') is-invalid @enderror" placeholder="Semestre" wire:model='semestre' wire:click='resetError'>
                ...
                <div class="modal fade" id="modifDepartements" tabindex="-1" wire:ignore.self>
                    <div class="modal-dialog modal-sm">
                        <div class="modal-content">
                            <div class="modal-header bg-card-modal">
                                <h3 class="modal-title">Modification d'un semestre</h3>
                                <button type="button" class="bg-btn-close-modal" data-bs-dismiss="modal" aria-label="Close"><i class="fa fa-times"></i></button>
                            </div>
                            <div class="modal-body">
                                <form action="" enctype="multipart/form-data">
        ...
        <div class="card-body">
            <div class="row table-responsive">
                <table class="table table-bordered table-hover">
                    ...
                    <tbody>
                        @forelse ( $semestress as $k => $s)
                        <tr>
                            <th>{{ $k+1 }}</th>
                            <td>{{ $s->semestre }}</td>
                            <td class="">
                                <a type="button" title="Modifier" class="fs-5 me-1" wire:click='edit({{ $s }})' data-bs-toggle="modal" data-bs-target="#modifDepartements"><i class="fa fa-edit btn-color-primary"></i></a>                               
                                <a class="me-1" href="" title="Supprimer" wire:click='delete({{ $s }})' wire:confirm="Est ce que vous voulez supprimé ce semestre ?"><i class="fs-5 fa fa-trash text-danger"></i></a>
                            </td>
                        </tr>
                        @empty
                        <tr>
            ...
            <div class="row">
                <div class="col-sm-12 col-md-12">
                    <ul class="pagination-rounded">
                        {{$semestress->links('vendor.livewire.bootstrap')}}
                    </ul>
                </div>
            </div>
        </div>
