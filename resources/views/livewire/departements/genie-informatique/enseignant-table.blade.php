<div> 
    <div class="card">
        ...
        <div class="d-flex flex-row justify-content-end px-2 pb-2">
            <a href="{{ route('genieinfo.enseignant.create')}}" class="btn-modal">
                        ...
                        @foreach ($enseignants as $k => $enseignant)
                            <tr wire:key="{{ $enseignant->id }}">
                                ...
                                <td class="p-1 d-flex gap-1 justify-content-end gap-2 ">
                                    <a href="{{ route('genieinfo.enseignant.show', $enseignant) }}" ><i class="bi bi-eye-fill cprimary"></i></a>
                                    <a href="{{ route('genieinfo.enseignant.edit', $enseignant) }}" ><i class="bi bi-pencil-square cprimary"></i></a>
                                        ...
                                        <div class="modal-dialog modal-dialog-centered">
                                          <div class="modal-content">
                                            ...
                                            <div class="modal-footer">
                                                ...
                                                <form action="{{ route('genieinfo.enseignant.destroy', $enseignant->id) }}" method="post">
                                                    @method('delete')
                                                    @csrf
