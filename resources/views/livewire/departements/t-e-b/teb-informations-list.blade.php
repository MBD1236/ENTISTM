<div> 
    <div class="card">
        <div class="card-header card-head">
            <h1 class="bg-card text-center text-white card-head"><i class="fa fa-users me-3"></i>
                ...
                @foreach ($informations as $k => $information)
                    @if ($information->departement == "Technologies des Equipements Biomédicaux" || $information->departement === "Technologie des equipements biomedicaux" )
        ...
        <div class="d-flex flex-row justify-content-end px-2">
            <a href="{{ route('teb.information.create')}}" class="btn-modal">
                    ...
                    <tr wire:key="{{ $information->id }}">
                       <div class="d-flex flex-row justify-content-between">
                            ...
                            <div class="d-flex flex-row gap-2">
                                <a href="{{ route('teb.information.show', $information) }}" ><i class="bi bi-eye-fill cprimary fs-1"></i></a>
                                <a href="{{ route('teb.information.edit', $information) }}" ><i class="bi bi-pencil-square cprimary fs-1"></i></a>
                            </div>
                       </div>
                       <div class="row fw-bold">
                        ...
                        <div class="my-4">
                            ...
                            <p> 
                                ...
                                <a href="{{ route('teb.information.show', $information) }}" ><i class="bi bi-eye-fill cprimary fs-3"></i><span class="fs-5 mx-2" style="color: #120a5c">Voir plus</span></a>
                            </p>
                        </div>
                    </tr>
                    @endif
