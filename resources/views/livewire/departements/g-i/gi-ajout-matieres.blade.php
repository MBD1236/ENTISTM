    ...
    <div class="card-body">
        <form action="" wire:submit="store">
                ...
                <div class="col-md-4 form-floating">
                    <div class="form-floating">
                        <select class="form-select border-input @error('semestre_id') is-invalid @enderror" wire:model="semestre_id" id="semestre_id" wire:click='clearStatus'>
                            <option value="0">Sélectionner un semestre</option>
            ...
            <div class="d-flex justify-content-center mt-2">
                <div class="me-2">
                    <button type="submit" class="btn-modal" style="height: 40px; padding: 0 5px;"><i class="fa fa-check me-2 mt-2"></i> Enregistrer</button>
                </div>
                <div>
                    <button type="button" class="btn btn-danger" wire:click='cancel'><i class="fa fa-times me-2 mt-2"></i> Annuler</button>
                </div>
            </div>
        </form>
    </div>
