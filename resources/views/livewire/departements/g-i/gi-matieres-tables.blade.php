    ...
    <div class="card">
        ...
        <div class="row m-2">
            ...
            <div class="col-md-4 mt-2">
                <a href="{{ route('genieinfo.matiere.ajout') }}" type="btn" class="btn-modal">Enregistrer une nouvelle matière</a>
            </div>
        </div>
                    ...
                    <tbody>
                        @forelse ($matieres as $k => $matiere)
                            <tr wire:key="{{ $matiere->id }}">
                                ...
                                <td class="">
                                    <a href="{{ route('genieinfo.matiere.edit', $matiere) }}"><i class="fa fa-edit btn-color-primary"></i></a>
