<div class="card">
    <div class="card-header card-head">
        <h1 class="bg-card text-center text-white card-head"><i class="fa fa-descri me-1"></i>Formulaire de modification de la description</h1>
    </div>
    <div class="card-body">
            ...
            <div class="row mt-3">
                <div class="col-md-9 m-auto">
                    <div class="row">
                        <div class="my-2">
                            <div class="form-floating">
                                ...
                                <label for="floatingdepartement" class="label-control label-text">Nom du département</label>
                            </div>
                        </div>
                        <div class="my-2">
                            <div class="form-floating">
                                ...
                                <label for="floatingcode" class="label-control label-text">Code</label>
                    ...
                    <div class="d-flex flex-row justify-content-center gap-3 my-3">
                        <div>
                            <button type="submit" class="btn-modal py-3"><i class="fa fa-check me-2"></i>Modification de la description</button>
                        </div>
                        <div>
