<div> 
    <div class="card">
        ...
        <div class="d-flex flex-row justify-content-end px-2">
            <a href="{{ route('imp.information.create')}}" class="btn-modal">
        ...
        <div class="card-body mt-5">
            <div class="table-responsive-sm">
                <table id="tableau" class="table table-hover mb-0 mt-4">
                    @foreach ($informations as $k => $information)
                    @if ($information->departement == "Instrumentation et Mesures Physiques" || $information->departement === "Instrumentation et Mesure Physique" )
                    <tr wire:key="{{ $information->id }}">
                       <div class="d-flex flex-row justify-content-between">
                            ...
                            <div class="d-flex flex-row gap-2">
                                <a href="{{ route('imp.information.show', $information) }}" ><i class="bi bi-eye-fill cprimary fs-1"></i></a>
                                <a href="{{ route('imp.information.edit', $information) }}" ><i class="bi bi-pencil-square cprimary fs-1"></i></a>
                            </div>
                       </div>
                       <div class="row fw-bold">
                        ...
                        <div class="my-4">
                            ...
                            <p> 
                                ...
                                <a href="{{ route('imp.information.show', $information) }}" ><i class="bi bi-eye-fill cprimary fs-3"></i><span class="fs-5 mx-2" style="color: #120a5c">Voir plus</span></a>
                            </p>
                        </div>
                    </tr>
                    @endif
