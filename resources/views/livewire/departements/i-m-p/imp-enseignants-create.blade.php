<div class="card">
    <div class="card-header card-head">
        <h1 class="bg-card text-center text-white card-head"><i class="fa fa-descri me-1"></i>Formulaire d'enregistrement des enseignants</h1>
    </div>
    <div class="card-body">
            ...
            <div class="row mt-3">
                <div class="col-md-9 m-auto">
                    <div class="row">
                        ...
                        <div class="col-md-6 my-2">
                            <div class="form-floating">
                                ...
                                <label for="floating" class="label-control label-text">Départements<span class="text-danger">*</span></label>
                    ...
                    <div class="d-flex flex-row justify-content-center gap-3 my-3">
                        <div>
                            <button type="submit" class="btn-modal py-3"><i class="fa fa-check me-2"></i>Enregistrer un enseignant</button>
                        </div>
                        <div>
