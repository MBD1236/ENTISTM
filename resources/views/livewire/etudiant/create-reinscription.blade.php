<div class="card">
    <div class="card-header card-head">
        <h1 class="bg-card text-center text-white card-head"><i class="fa fa-graduation-cap me-3"></i>Ma réinscription</h1>
    </div>
    <div class="card-body">
        <div class="">
        ...
        @csrf
            <div class="row">
                <div class="col-md-4 mt-1">
                    <input class="form-control border-input" type="search" wire:model="inerecherche" id="floatinginerecherche" placeholder="Entrez votre ine">
                </div>
                <div class="col-md-4">
                    <button type="submit" class="btn-modal"><i class="fa fa-search me-3"></i>Rechercher</button>
                </div>
            ...
            <div class="row mt-3">
                ...
                <div class="col-md-3">
                    ...
                    <div class="row mt-2">
                        <div class="row">
                            <div class="col">
                                <center><button type="button" class="btn-modal"><i class="fa fa-camera me-2"></i>Caméra</button></center>
                            </div>
                        </div>
                        <div class="row mt-2">
                            <div class="col">
