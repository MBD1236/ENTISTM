        ...
        <div class="row">
            <div class="col-md-4 col-sm-12 mt-2 p-1">
                <div class="form-group">
                    ...
                    <select wire:model.live="programme_id" name="programme_id" id="programme_id" class="form-select border-input @error('programme_id') is-invalid @enderror" type="search" style="height: 40px;">
                        <option value="0">programmes</option>
            ...
            <div class="col-md-3 my-5">
                <a href="{{ route('scolarite.attestation.create')}}" class="btn-modal py-3 "><i class="fa fa-plus me-1"></i><span>Ajouter un nouveau attestation</span></a>
            <div>
        </div>
    </div>
