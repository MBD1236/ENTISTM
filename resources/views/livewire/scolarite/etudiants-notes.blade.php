    ...
    <div class="card">
        <div class="card-header card-head">
            ...
            <div class="row mt-2">
                ...
                <div class="col-md-2">
                    <select wire:model.live="departement_id" id="departement_id" class="form-select @error('departement_id') is-invalid @enderror">
                ...
                <div class="col-md-2">
                    <select wire:model.live="programme_id" id="programme_id" class="form-select @error('programme_id') is-invalid @enderror">
                ...
                <div class="col-md-2">
                    <input type="text" wire:model.live.debounce.500ms='promotion' class="form-control" placeholder="Entrer la promotion">
                </div>
                <div class="col-md-1"></div>
            ...
            <div class="d-flex justify-content-end">
                ...
                <div class="mt-3 me-2">
                    <input class="form-control border-input" type="search" wire:model.live.debounce.200ms='searchE' id="searchE" placeholder="Selon un critère">
                </div>
            </div>
        </div>
