            ...
            <div class="row my-3">
                <div class="col-md-6">
                    <form action="" wire:submit='importer'>
                        <div class="row">
                            <h4 class="label-text my-2"><i class="fa fa-file me-1"></i>Importer la liste des étudiants orientés</h4>
                ...
                <div class="col-md-6">
                    <div class="row">
                        <h4 class="label-text my-2"><i class="fa fa-filter me-1"></i>Filtrer la liste par </h4>
