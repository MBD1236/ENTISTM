                                ...
                                <div class="row mt-3">
                                    ...
                                    <div class="col-md-4 form-floating">
                                        <div class="form-floating">
                                            ...
                                            <label for="floatingpv" class="label-control label-text">PV</label>
                                ...
                                <div class="row mt-3">
                                    <div class="col-md-4 form-floating">
                                        <div class="form-floating">
                                            ...
                                            <label for="floatingsession" class="label-control label-text">Session</label>
                                    ...
                                    <div class="col-md-4 form-floating">
                                        <div class="form-floating">
                                            ...
                                            <label for="floatingprofil" class="label-control label-text">Profil</label>
                                    ...
                                    <div class="col-md-4 form-floating">
                                        <div class="form-floating">
                                            ...
                                            <label for="floatingcentre" class="label-control label-text">Centre</label>
                                ...
                                <div class="row mt-3">
                                    <div class="col-md-4 form-floating">
                                        <div class="form-floating">
                                            ...
                                            <label for="floatingecole_origine" class="label-control label-text">École d'origine</label>
                                    ...
                                    <div class="col-md-4 form-floating">
                                       <div class="form-floating">
                                            ...
                                            <label for="floatingdate_naissance" class="label-control label-text">Date de Naissance</label>
                                    ...
                                    <div class="col-md-4 form-floating">
                                        <div class="form-floating">
                                            ...
                                            <label for="floatinglieu_naissance" class="label-control label-text">Lieu de Naissance</label>
                                ...
                                <div class="row mt-3">
                                    <div class="col-md-4 form-floating">
                                        <div class="form-floating">
                                            ...
                                            <label for="floatingpere" class="label-control label-text">Père</label>
                                    ...
                                    <div class="col-md-4 form-floating">
                                        <div class="form-floating">
                                            ...
                                            <label for="floatingmere" class="label-control label-text">Mère</label>
                                ...
                                <div class="row mt-3">
                                    ...
                                    <div class="col-md-4 form-floating">
                                        <div class="form-floating">
                                            ...
                                            <label for="floatingnom_tuteur" class="label-control label-text">Nom du tuteur</label>
                                    ...
                                    <div class="col-md-4 form-floating">
                                        <div class="form-floating">
                                            ...
                                            <label for="floatingtelephone_tuteur" class="label-control label-text">Téléphone du tuteur</label>
                                ...
                                <div class="row mt-3">
                                    <div class="col-md-4 form-floating">
                                        <div class="form-floating">
                                            ...
                                            <label for="floatingdiplome" class="label-control label-text">Diplôme</label>
                                    ...
                                    <div class="col-md-4 form-floating">
                                        <div class="form-floating">
                                            ...
                                            <label for="floatingreleve_notes" class="label-control label-text">Relevé de Notes</label>
                                    ...
                                    <div class="col-md-4 form-floating">
                                        <div class="form-floating">
                                            ...
                                            <label for="floatingextrait_naissance" class="label-control label-text">Extrait de Naissance</label>
                                ...
                                <div class="row mt-3">
                                    <div class="col-md-4 form-floating">
                                        <div class="form-floating">
                                            ...
                                            <label for="floatingcertificat_nationalite" class="label-control label-text">Certificat de Nationalité</label>
                                    ...
                                    <div class="col-md-4 form-floating">
                                        <div class="form-floating">
                                            ...
                                            <label for="floatingcertificat_medical" class="label-control label-text">Certificat de Medical</label>
