...
return [
    ...
    |-------------------------------------
    */
    'name' => env('CHATIFY_NAME', 'entistmamou'),
    ...
    */
    'attachments' => [
        ...
        'allowed_images' => (array) ['jpg', 'jpeg', 'png', 'gif', 'bmp', 'tiff', 'webp', 'svg'],
        'allowed_files' => (array) ['pdf', 'doc', 'docx', 'xls', 'xlsx', 'zip', 'rar', 'txt'],
        'max_upload_size' => env('CHATIFY_MAX_FILE_SIZE', 200), // MB
    ],
